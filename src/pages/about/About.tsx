  ...
  return (
    <div className='aboutPage'>
      <div className="carta">
        ...
        <p>A quien corresponda:<br/>    </p>
        <p>Ante todo, gracias por su tiempo en atender esta carta. Mi Nombre es <span>Obeth Torres </span> 
        ...
        disposición para realizar las entrevistas técnicas necesarias. <br />
        </p>
        <p>Sin más por el momento, reitero mi agradecimiento. <br/></p>
        
    
        <p><span>Atte. OTM</span></p>
      </div>
